...
$toolsDir   = "C:\AutoPackages\AdguardTeam.AdGuardHome.AdGuardHomewindowsamd64.zip"

$packageArgs = @{
    packageName     = "AdguardTeam.AdGuardHome.AdGuardHomewindowsamd64.zip"
    url             = "https://github.com/AdguardTeam/AdGuardHome/releases/download/v0.107.38/AdGuardHome_windows_amd64.zip"
