...
$toolsDir   = "C:\AutoPackages\horsicq.nauz-file-detector.nfd_win64_portable"

$packageArgs = @{
    packageName     = "horsicq.nauz-file-detector.nfd_win64_portable"
    url             = "https://github.com/horsicq/Nauz-File-Detector/releases/download/0.09/nfd_win64_portable_0.09.zip"
