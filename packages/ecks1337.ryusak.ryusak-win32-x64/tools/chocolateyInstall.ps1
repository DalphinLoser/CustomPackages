...
$toolsDir   = "C:\AutoPackages\ecks1337.ryusak.ryusak-win32-x64"

$packageArgs = @{
    packageName     = "ecks1337.ryusak.ryusak-win32-x64"
    url             = "https://github.com/Ecks1337/RyuSAK/releases/download/v1.6.2/RyuSAK-win32-x64-1.6.2.zip"
